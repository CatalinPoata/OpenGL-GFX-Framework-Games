...
namespace implemented
{
    class CameraHW
    {
     public:
        ...
        CameraHW(const glm::vec3& position, const glm::vec3& center, const glm::vec3& up, const glm::vec3& offset)
        {
            Set(position + offset, center, up);
            this->distanceToTarget = glm::distance(position + offset, center);
        }
        ...
        void TranslateRight(float distance)
        {
            ...
            this->position += glm::normalize(glm::vec3(right.x, 0, right.z)) * distance;
        }
        ...
        void RotateFirstPerson_OY(float angle)
        {
            ...
            forward = glm::normalize(glm::vec3(aux));
            glm::vec4 aux2 = glm::rotate(glm::mat4(1.0f), angle, glm::vec3(0, 1, 0)) * glm::vec4(right, 1);
